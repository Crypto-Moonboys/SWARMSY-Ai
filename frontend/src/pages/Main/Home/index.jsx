  ...
  if (workspaceLoading) {
    return (
      <div
        ...
        className="transition-all duration-500 relative md:ml-[2px] md:mr-[16px] md:my-[16px] md:rounded-[16px] bg-black light:bg-white w-full h-full overflow-hidden"
      />
    );
  }
...
function HomeContent({ workspace, setWorkspace, threadSlug, setThreadSlug }) {
  ...
  return (
    <ChatSidebarProvider>
      ...
      >
        <ChatSettingsMenu />
        <div className="flex-1 min-w-0 transition-all duration-500 relative md:rounded-[16px] bg-black light:bg-white w-full h-full overflow-hidden border-none light:border-solid light:border light:border-theme-modal-border">
